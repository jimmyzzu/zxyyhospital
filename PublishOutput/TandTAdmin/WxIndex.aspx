<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WxIndex.aspx.cs" Inherits="TandT.WeixinWeb.TandTAdmin.WxIndex" %>
...
<script type="text/javascript" charset="utf-8" src="js/laywxindex.js"></script>
    ...
    <div class="nav-right">
      <div class="info">
        ...
        <span>
          ...
          <%=new TandT.BLL.manager_role().GetTitle(admin_info.role_id) %>
        </span>
      </div>
      <div class="option">
        <i></i>
