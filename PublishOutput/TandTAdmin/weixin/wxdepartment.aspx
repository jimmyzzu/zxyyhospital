<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wxdepartment.aspx.cs" Inherits="TandT.WeixinWeb.TandTAdmin.weixin.wxdepartment" %>
...
<div id="floatHead" class="toolbar-wrap">
  <div class="toolbar">
    <div class="box-wrap">
      ...
      <div class="l-list">
        <ul class="icon-list">
          <li><a class="add" href="wxdepartment_edit.aspx?action=<%=DTEnums.ActionEnum.Add %>"><i></i><span>新增</span></a></li>
...
<div class="table-container">
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="ltable">
    <tr>
      <th width="6%">选择</th>
      <th align="left" width="12%">科室编号</th>
      <th align="left" width="24%">科室名称</th>
      <th align="left" width="6%">上级科室</th>
