<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wxggtuisong.aspx.cs" Inherits="TandT.WeixinWeb.TandTAdmin.weixin.wxggtuisong" %>
...
<!--导航栏-->
<div class="location">
  <a href="wxggtuisong.aspx" class="back"><i></i><span>返回上一页</span></a>
...
<div id="floatHead" class="toolbar-wrap">
  <div class="toolbar">
    <div class="box-wrap">
      ...
      <div class="l-list">
        <ul class="icon-list">
          <li><a class="add" href="wxggtuisong_edit.aspx?action=<%=DTEnums.ActionEnum.Add %>&channel_id=<%=this.channel_id %>"><i></i><span>新增</span></a></li>
  ...
  <ItemTemplate>
      <li>
        <div class="details<%#Eval("PicURL").ToString() != "" ? "" : " nopic"%>">
          ...
          <h1><span><a href="wxggtuisong.aspx?action=<%#DTEnums.ActionEnum.Edit %>&ID=<%#Eval("ID")%>"></a></span></h1>
          <div class="remark">
            <%#Eval("PicName").ToString() == "" ? "暂无图片名称..." : Eval("PicName").ToString()%>
          </div>
          <div class="tools">
          ...
          <div class="foot">
            ...
            <a href="wxggtuisong_edit.aspx?action=<%#DTEnums.ActionEnum.Edit %>&ID=<%#Eval("ID")%>" title="编辑" class="edit">编辑</a>
          </div>
        </div>
      </li>
  </ItemTemplate>
