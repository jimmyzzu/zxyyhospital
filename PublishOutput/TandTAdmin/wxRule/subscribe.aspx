<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="subscribe.aspx.cs" Inherits="TandT.WeixinWeb.TandTAdmin.wxRule.subscribe" %>
...
<script type="text/javascript" charset="utf-8" src="../js/common.js"></script>
    <script type="text/javascript">
        ...
        function showGuiZeDialog(id) {
            ...
            var contenturl = "";
            if (id == 0) {
                contenturl = "wxRule/addNews.aspx?option=add&rid=" + rid + "&act=" + act;
            }
            else {
                contenturl = "wxRule/addNews.aspx?option=edit&rid=" + rid + "&id=" + id + "&act=" + act;
            }
            var m = top.dialog({
                id: 'dialogGuiZe',
                fixed: true,
...
<body class="mainbody">
    ...
    <div class="tab-content">
        ...
        <dl>
            ...
            <dd>
                <div class="rule-multi-radio">
                    <asp:RadioButtonList ID="rblResponseType" runat="server" RepeatDirection="Horizontal"
                        RepeatLayout="Flow">
        ...
        <dl class="wenben" style="display: none;">
            <dt>内容</dt>
            <dd>
                <asp:TextBox ID="txtContent" runat="server" CssClass="input" Style="height: 300px;"
                    TextMode="MultiLine" datatype="*0-1000" sucmsg="*最多1000个字符 "></asp:TextBox>
        ...
        <dl id="div_music_title" style="display: none;" class="music">
            <dt>音乐标题</dt>
            <dd>
                <asp:TextBox ID="txtMusicTitle" runat="server" CssClass="input normal" datatype="*0-255"
                    sucmsg="最多30个字符 " />
        ...
        <dl class="picnews" style="display: none;">
            <dt></dt>
            <dd>
                <a id="itemAddButton" class="icon-btn add"><i></i><span>添加内容</span></a> <span class="Validform_checktip">
                </span>
            </dd>
        </dl>
        <dl class="picnews" style="display: none;">
                    ...
                    <tbody id="var_box">
                        <asp:Repeater ID="rpnewsList" runat="server" OnItemCommand="rptList_ItemCommand">
                            <ItemTemplate>
                                <tr class="td_c">
                                    <td>
                                        <asp:Image ID="Image1" runat="server" ImageUrl='<%#Eval("picUrl")%>' Style="max-height: 50px;
                                            max-width: 100px;" />
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        ...
                                        <asp:LinkButton ID="LinkButton1" runat="server" OnClientClick="return DelExePostBack(this);"
