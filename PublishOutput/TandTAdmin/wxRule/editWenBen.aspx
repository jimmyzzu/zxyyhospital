<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="editWenBen.aspx.cs" ValidateRequest="false"
    Inherits="TandT.WeixinWeb.TandTAdmin.wxRule.editWenBen" %>
...
<body class="mainbody">
    ...
    <!--导航栏-->
    <div class="location">
        <a href="wenBenList.aspx" class="back"><i></i><span>返回列表页</span></a> <i class="arrow">
        </i><span>编辑文本回复</span>
    </div>
    <div class="line10">
    </div>
    ...
    <div class="tab-content">
        <dl>
            <dt>关键词</dt>
            <dd>
                <asp:TextBox ID="txtreqKeywords" runat="server" CssClass="input normal " datatype="*1-1000"
        ...
        <dl>
            ...
            <dd>
                <div class="rule-multi-radio">
                    <asp:RadioButtonList ID="rblisLikeSearch" runat="server" RepeatDirection="Horizontal"
                        RepeatLayout="Flow">
        ...
        <dl>
            <dt>内容或简介</dt>
            <dd>
                <asp:TextBox ID="txtrContent" runat="server" CssClass="mytextarea" TextMode="MultiLine"
                    datatype="*1-1000" sucmsg=" " nullmsg="内容或简介"></asp:TextBox>
