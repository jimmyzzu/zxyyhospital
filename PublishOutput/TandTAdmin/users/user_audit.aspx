<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="user_audit.aspx.cs" Inherits="TandT.WeixinWeb.TandTAdmin.users.user_audit" %>
...
<ItemTemplate>
  <tr>
    ...
    <td><%#new TandT.BLL.user_groups().GetTitle(Convert.ToInt32(Eval("group_id")))%></td>
