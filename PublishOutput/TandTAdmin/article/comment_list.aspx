<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="comment_list.aspx.cs" Inherits="TandT.WeixinWeb.TandTAdmin.article.comment_list" %>
    ...
    <tr>
      <td class="comment">
        <div class="title">
          ...
          <%#new TandT.BLL.article().GetTitle(Convert.ToInt32(Eval("article_id")))%>
        </div>
        <div class="ask">
