<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MapSelectPoint.aspx.cs" Inherits="TandT.WeixinWeb.TandTAdmin.lbs.MapSelectPoint" %>
...
<head>
   ...
   <script type="text/javascript" charset="utf-8" src="../../scripts/jquery/jquery-1.11.2.min.js"></script>
    <script type="text/javascript" charset="utf-8"  src="../../scripts/jquery/jquery.query.js"></script>
    <title>鼠标点击拾取坐标 
    </title>
</head>
<body>
...
<script type="text/javascript">
    ...
    map.centerAndZoom(new BMap.Point(y_jindu, x_weidu), 14);                   // 初始化地图,设置城市和地图级别。
