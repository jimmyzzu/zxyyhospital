<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="lbslist.aspx.cs" Inherits="TandT.WeixinWeb.TandTAdmin.lbs.lbslist" %>
            ...
            <a class="menu-btn"></a>
                <div class="l-list">
                    <ul class="icon-list">
                        ...
                        <li><a class="add" href="lbsedit.aspx?action=<%=DTEnums.ActionEnum.Add %>"><i></i><span>新增地理位置数据</span></a></li>
        ...
        <asp:Repeater ID="rptList1" runat="server"  >
            ...
            <ItemTemplate>
                <tr>
                    ...
                    <td align="center">
                        <a href="lbsedit.aspx?action=<%#DTEnums.ActionEnum.Edit %>&id=<%#Eval("id")%>">修改</a>
                    </td>
                </tr>
            </ItemTemplate>
            <FooterTemplate>
