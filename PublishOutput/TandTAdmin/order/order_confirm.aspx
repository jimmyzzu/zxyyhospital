<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="order_confirm.aspx.cs" Inherits="TandT.WeixinWeb.TandTAdmin.order.order_confirm" %>
...
<ItemTemplate>
  <tr>
    ...
    <td><%#new TandT.BLL.payment().GetTitle(Convert.ToInt32(Eval("payment_id")))%></td>
    <td><%#new TandT.BLL.express().GetTitle(Convert.ToInt32(Eval("express_id")))%></td>
