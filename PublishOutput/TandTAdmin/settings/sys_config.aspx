<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sys_config.aspx.cs" Inherits="TandT.WeixinWeb.TandTAdmin.settings.sys_config" ValidateRequest="false" %>
...
<div class="tab-content" style="display:none">
  ...
  <dl>
    ...
    <dd>
      ...
      <span class="Validform_checktip">*默认TandTAdmin，其它请输入目录名，否则无法进入后台</span>
    </dd>
  </dl>
  <dl>
    <dt>URL重写开关</dt>
