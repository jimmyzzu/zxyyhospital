<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ZhuYuanIndex.aspx.cs" Inherits="TandT.WeixinWeb.HospitalWeb.ZhuYuanIndex" %>
...
<body>
    ...
    <ul class="nav-list" style="margin:8px 8px 8px 2px;">
        ...
        <a title="住院须知" href="zhuyuanxuzhi.html">
        <li onclick="" class="mzxz">
            <div class="c-ff9913">住院须知</div>
        </li>
        </a>
        <a title="住院部导航" href="zzyyDaohanglist2.html"> <li onclick="" class="yndh">
            <div class="c-ffb517">住院部导航</div>
        </li></a>
        <%--<a title="预约住院" href="kaifa.html"><li onclick="" class="tjtccx">
            <div class="c-8a95ff">预约住院</div>
        </li></a>
