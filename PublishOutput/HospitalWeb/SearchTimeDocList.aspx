<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SearchTimeDocList.aspx.cs" Inherits="TandT.WeixinWeb.HospitalWeb.SearchTimeDocList" %>
...
<section class="ui-blk">
    ...
    <asp:Repeater ID="rptList1" runat="server">
                                    <ItemTemplate>
        <a href="MenZhenDocDetail.aspx?docid=<%#Eval("doctorId")%>&departid=<%#Eval("deptId")%>&department=<%#Eval("deptName")%>&SearchTime=<%=SearchTime%>&comefrom=SearchTimeDocList">
