<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SpecialDeptList.aspx.cs" Inherits="TandT.WeixinWeb.HospitalWeb.SpecialDeptList" %>
...
<body>
    ...
    <div class="ui-blk-cnt jobs-list">
     <asp:Repeater ID="rptList1" runat="server">
                                    <ItemTemplate>
        <a href="MenZhenDocList.aspx?id=<%#Eval("id")%>&departName=<%#Eval("name")%>">
