<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SearchTimeThirDepart.aspx.cs" Inherits="TandT.WeixinWeb.HospitalWeb.SearchTimeThirDepart" %>
...
<body>
    ...
    <div class="ui-blk-cnt jobs-list">
     <asp:Repeater ID="rptList1" runat="server">
                                    <ItemTemplate>
        <a href="SearchTimeDocList.aspx?departid=<%#Eval("id")%>&departName=<%#Eval("name")%>&SearchTime=<%=SearchTime %>">
