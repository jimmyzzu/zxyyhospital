<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SearchTimeDepart.aspx.cs" Inherits="TandT.WeixinWeb.HospitalWeb.SearchTimeDepart" %>
...
<body>
    ...
    <div class="ui-blk-cnt jobs-list">
     <asp:Repeater ID="rptList1" runat="server">
                                    <ItemTemplate>
        <a href="SearchTimeSeDePart.aspx?id=<%#Eval("id")%>&departName=<%#Eval("name")%>&SearchTime=<%=SearchTime %>">
