<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GuahaoMode_Zhuanke.aspx.cs" Inherits="TandT.WeixinWeb.HospitalWeb.GuahaoMode_Zhuanke" %>
...
<body>
    ...
    <div class="ui-blk-cnt jobs-list">
        ...
        <a href="SpecialDeptList.aspx?HosId=<%=HosId%>&departName=专科门诊">
            <h4 class="jobs-hd">我要约专科</h4>
