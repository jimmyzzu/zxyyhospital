<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SearchTimeSeDePart.aspx.cs" Inherits="TandT.WeixinWeb.HospitalWeb.SearchTimeSeDePart" %>
...
<body>
    ...
    <div class="ui-blk-cnt jobs-list">
     <asp:Repeater ID="rptList1" runat="server">
                                    <ItemTemplate>
        <a href="SearchTimeThirDepart.aspx?id=<%#Eval("id")%>&departName=<%#Eval("name")%>&SearchTime=<%=SearchTime %>">
