<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MenZhenDocList.aspx.cs" Inherits="TandT.WeixinWeb.HospitalWeb.MenZhenDocList" %>
...
<section class="ui-blk">
    ...
    <asp:Repeater ID="rptList1" runat="server">
                                    <ItemTemplate>
        <a href="MenZhenDocDetail.aspx?docid=<%#Eval("id")%>&departid=<%=deptid%>&department=<%=departName%>">
            ...
            <div class="fr-text">   
                ...
                <span class="jobs-name"><%#Eval("title") != null && Eval("title") != "" ? Eval("title") : "暂无"%></span>
            </div>
        </a>
         </ItemTemplate>
                                </asp:Repeater>
