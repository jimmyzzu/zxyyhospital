<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FistDepart.aspx.cs" Inherits="TandT.WeixinWeb.HospitalWeb.FistDepart" %>
...
<body>
    ...
    <div class="ui-blk-cnt jobs-list">
     <asp:Repeater ID="rptList1" runat="server">
                                    <ItemTemplate>
        <a href="SecondDepart.aspx?id=<%#Eval("id")%>&departName=<%#Eval("name")%>">
