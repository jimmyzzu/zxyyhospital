<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TiJianIndex.aspx.cs" Inherits="TandT.WeixinWeb.HospitalWeb.TiJianIndex" %>
...
<body>
  ...
  <asp:Repeater ID="rptList1" runat="server">
    ...
    <ul class="nav-list" style="margin:8px 8px 8px 2px;">
        ...
        <a title="体检须知" href="tijianxuzhi.html">
        <li onclick="" class="yyghxz">
            <div class="c-62c500">体检须知</div>
        </li></a>
        <a title="体检套餐查询" href="TiJianHosipitalSelect.html"><li onclick="" class="yyghdd">
            <div class="c-84d018">体检套餐查询</div>
        </li></a>

      <%--   <a title="预约体检" href="kaifa.html"><li onclick="" class="tjtccx">
            <div class="c-8a95ff">预约体检</div>
        </li></a>--%>
        <%--<a title="预约体检" href="kaifa.html"><li onclick="" class="ksdh">
            <div class="c-8a95ff">预约体检</div>
        </li></a>--%>
         <a title="体检报告查询" href="Pocket_MedicalExaminationReport.aspx">
        <li onclick="" class="tjtccx">
            <div class="c-8a95ff">体检报告查询</div>
        </li></a>
        
    </ul>    
<%--<p style=" color:#888; text-align:center; font-size:0.8em;text-shadow: 0.1em 0.1em 0.1em #ccc;">技术支持:郑州大学互联网医疗与健康服务河南省协同创新中心</p>--%>        
</nav>
<p style=" color:#888; text-align:center; font-size:0.8em;text-shadow: 0.1em 0.1em 0.1em #ccc;  position: fixed !important; position: absolute;
        z-index: 9999; bottom: 70px !important; width:100%;">技术支持:郑州大学互联网医疗与健康服务河南省协同创新中心</p>
