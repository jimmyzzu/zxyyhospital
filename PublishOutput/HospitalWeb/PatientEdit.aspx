<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PatientEdit.aspx.cs" Inherits="TandT.WeixinWeb.HospitalWeb.PatientEdit" %>
...
<header class="ui-blk-tit">
    <h3>挂号人信息<asp:Literal ID="LitHead" runat="server"></asp:Literal></h3>
</header>
<section class="ui-blk">
    <div class="ui-blk-cnt jobs-list" style="border:none;">
        ...
        <asp:Button ID="ButtonQueding" runat="server" Text="确定" 
          ...
          <br /><br /><%--
        <div class="buttons mt20">
        <asp:Button ID="ButtonDele" runat="server" Text="删除此人信息" 
