<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="zzyyDaozhen_w1.aspx.cs" Inherits="TandT.WeixinWeb.Daozhen.zzyyDaozhen_w1" %>
...
<body id="daozhen1" class=" bg3">
 ...
 <section class="suggestion">
			<div class="nav">
			   ...
			   <span class="item on"><a href="javascript:void(0);">女性</a></span>
			   <span class="item"><a href="zzyyDaozhen_c1.aspx">儿童</a></span>
		    </div>
</section>
<div class="renwu" style=" background-image:url(images/w1.png)">
<div class="renwu1" style="height:100%; width:50%; float:left;">
 ...
 <div class="renwu_10 "style="width:59%;height:2px;margin:0px auto;padding:0px;background-color:#21a2c6;overflow:hidden; top: 68.8%; position: relative;right:-8%;"></div>
...
<div class="renwu_2 "style="width:76%;height:2px;margin:0px auto;padding:0px;background-color:#21a2c6;overflow:hidden; top: 5.8%; position: relative;left: -9%;"></div>
 ...
 <div class="renwu_4 "style="width:70%;height:2px;margin:0px auto;padding:0px;background-color:#21a2c6;overflow:hidden; top: 30.8%; position: relative;left: -5.9%;"></div>
 ...
 <a href="zzyyDaozhen_w2.aspx" style="top: 53.1%;left: 79%;border-radius: 6px; display: block;text-align: center; line-height: 30px; position: relative; width: 60px;"><span class="btn12"><img src="images/zs_btn.png" style=" " /></span></a>
 </div>
 </div>
