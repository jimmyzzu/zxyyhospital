<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="zzyyDaozhen_c1.aspx.cs" Inherits="TandT.WeixinWeb.Daozhen.zzyyDaozhen_c1" %>
...
<body id="daozhen1" class=" bg3">
 ...
 <section class="suggestion">
			<div class="nav">
			   ...
			   <span class="item on"><a href="">儿童</a></span>
		    </div>
</section>
<div class="renwu" style=" background-image:url(images/c1.png)">
<div class="renwu1" style="height:100%; width:50%; float:left;">
 <div class="renwu_6 "style="width:55%;height:2px;margin:0px auto;padding:0px;background-color:#21a2c6;overflow:hidden; top: 11.8%; position: relative; right:-15%;"></div>
 <button onclick="return false;"  class="btn6" style=" width:90px;"><a href=""><span >耳眼口鼻</span></a></button>
 <div class="renwu_7 "style="width:68%;height:2px;margin:0px auto;padding:0px;background-color:#21a2c6;overflow:hidden; top: 23.8%; position: relative;right:-12%;"></div>
 <button onclick="return false;"  class="btn7"><a href=""><span>颈部</span></a></button>
 <div class="renwu_8 "style="width:44%;height:2px;margin:0px auto;padding:0px;background-color:#21a2c6;overflow:hidden; top: 30.8%; position: relative;right:5%;"></div>
 <button onclick="return false;"  class="btn8"><a href=""><span>上肢</span></a></button>
 <div class="renwu_9 "style="width:27%;height:2px;margin:0px auto;padding:0px;background-color:#21a2c6;overflow:hidden; top: 41.8%; position: relative;right:13%;"></div>
 <button onclick="return false;"  class="btn9"><a href=""><span>手部</span></a></button>
 <div class="renwu_10 "style="width:59%;height:2px;margin:0px auto;padding:0px;background-color:#21a2c6;overflow:hidden; top: 65.8%; position: relative;right:-8%;"></div>
...
<div class="renwu_2 "style="width:76%;height:2px;margin:0px auto;padding:0px;background-color:#21a2c6;overflow:hidden; top: 12.8%; position: relative;left: -9%;"></div>
 <button onclick="return false;"  class="btn2"><a href=""><span>面部</span></a></button>
 <div class="renwu_3 "style="width:70%;height:2px;margin:0px auto;padding:0px;background-color:#21a2c6;overflow:hidden; top: 38.8%; position: relative;left: -6.9%;"></div>
 <button onclick="return false;"  class="btn3"><a href=""><span>腹部</span></a></button>
 <div class="renwu_4 "style="width:70%;height:2px;margin:0px auto;padding:0px;background-color:#21a2c6;overflow:hidden; top: 41.8%; position: relative;left: -5.9%;"></div>
 ...
 <a href="zzyyDaozhen_c2.aspx" style="top: 53.1%;left: 79%;border-radius: 6px; display: block;text-align: center; line-height: 30px; position: relative; width: 60px;"><span class="btn12"><img src="images/zs_btn.png" style=" " /></span></a>
 </div>
 </div>
