<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="zzyyDaozhen_doctorlist.aspx.cs" Inherits="TandT.WeixinWeb.Daozhen.zzyyDaozhen_doctorlist" %>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $(".jibingleft a").each(function (i, v) {
            //左侧栏默认激活
